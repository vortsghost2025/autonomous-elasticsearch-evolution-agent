 ...
 */
import BaseConnectionPool, { defaultNodeFilter } from './BaseConnectionPool.js';
import assert from 'node:assert';
import Debug from 'debug';
import { BaseConnection } from '../connection/index.js';
const debug = Debug('elasticsearch');
class ClusterConnectionPool extends BaseConnectionPool {
    constructor(opts) {
        var _a, _b, _c;
        super(opts);
     ...
     */
    getConnection(opts) {
        const filter = opts.filter != null ? opts.filter : defaultNodeFilter;
...
export default ClusterConnectionPool;
