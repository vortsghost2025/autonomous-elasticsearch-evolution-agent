...
import { ConfigurationError, RequestAbortedError, ConnectionError, TimeoutError } from '../errors.js';
    ...
    constructor(opts) {
        ...
        if (typeof opts.agent === 'function') {
            ...
            if (this[kCaFingerprint] !== null) {
                ...
                const connector = buildConnector(((_c = this.tls) !== null && _c !== void 0 ? _c : {}));
    ...
    async request(params, options) {
        ...
        try {
            ...
            switch (err.code) {
                ...
                case 'UND_ERR_SOCKET':
                    throw new ConnectionError(`${err.message} - Local: ${(_e = (_d = err.socket) === null || _d === void 0 ? void 0 : _d.localAddress) !== null && _e !== void 0 ? _e : 'unknown'}:${(_g = (_f = err.socket) === null || _f === void 0 ? void 0 : _f.localPort) !== null && _g !== void 0 ? _g : 'unknown'}, Remote: ${(_j = (_h = err.socket) === null || _h === void 0 ? void 0 : _h.remoteAddress) !== null && _j !== void 0 ? _j : 'unknown'}:${(_l = (_k = err.socket) === null || _k === void 0 ? void 0 : _k.remotePort) !== null && _l !== void 0 ? _l : 'unknown'}`); // eslint-disable-line
                default:
        ...
        const bodyIsBinary = isBinary((_o = response.headers['content-type']) !== null && _o !== void 0 ? _o : '');
        /* istanbul ignore else */
