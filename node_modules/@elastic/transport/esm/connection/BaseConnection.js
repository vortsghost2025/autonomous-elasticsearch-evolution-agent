...
class BaseConnection {
    constructor(opts) {
        ...
        this[kStatus] = (_h = opts.status) !== null && _h !== void 0 ? _h : BaseConnection.statuses.ALIVE;
        this[kDiagnostic] = (_j = opts.diagnostic) !== null && _j !== void 0 ? _j : new Diagnostic();
        this[kCaFingerprint] = (_k = opts.caFingerprint) !== null && _k !== void 0 ? _k : null;
    ...
    [(_a = kStatus, _b = kCaFingerprint, _c = kDiagnostic, inspect.custom)](depth, options) {
...
export function prepareHeaders(headers = {}, auth) {
...
export function getIssuerCertificate(socket) {
...
export function isCaFingerprintMatch(cert1, cert2) {
