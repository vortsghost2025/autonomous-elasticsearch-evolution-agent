...
class Tasks {
    ...
    async cancel(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['tasks.cancel'];
    ...
    async get(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['tasks.get'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async list(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['tasks.list'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
