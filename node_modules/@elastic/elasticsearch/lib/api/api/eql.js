...
class Eql {
    ...
    async delete(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['eql.delete'];
    ...
    async get(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['eql.get'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async getStatus(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['eql.get_status'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async search(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[symbols_1.kAcceptedParams]['eql.search'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
