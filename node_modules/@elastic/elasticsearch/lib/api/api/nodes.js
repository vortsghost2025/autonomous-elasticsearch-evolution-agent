...
class Nodes {
    ...
    async clearRepositoriesMeteringArchive(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['nodes.clear_repositories_metering_archive'];
    ...
    async getRepositoriesMeteringInfo(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['nodes.get_repositories_metering_info'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async hotThreads(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['nodes.hot_threads'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async info(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['nodes.info'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async reloadSecureSettings(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[symbols_1.kAcceptedParams]['nodes.reload_secure_settings'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async stats(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['nodes.stats'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async usage(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['nodes.usage'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
