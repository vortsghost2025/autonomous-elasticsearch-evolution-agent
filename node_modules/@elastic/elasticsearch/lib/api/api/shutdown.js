...
class Shutdown {
    ...
    async deleteNode(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['shutdown.delete_node'];
    ...
    async getNode(params, options) {
        const { path: acceptedPath } = this[symbols_1.kAcceptedParams]['shutdown.get_node'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async putNode(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[symbols_1.kAcceptedParams]['shutdown.put_node'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
