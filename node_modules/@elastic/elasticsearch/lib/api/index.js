...
const project_1 = tslib_1.__importDefault(require("./api/project"));
...
const streams_1 = tslib_1.__importDefault(require("./api/streams"));
...
Object.defineProperties(API.prototype, {
    ...
    project: {
        get() { return this[kProject] === null ? (this[kProject] = new project_1.default(this.transport)) : this[kProject]; }
    },
    queryRules: {
    ...
    streams: {
        get() { return this[kStreams] === null ? (this[kStreams] = new streams_1.default(this.transport)) : this[kStreams]; }
    },
    synonyms: {
