...
class Client extends api_1.default {
    constructor(opts) {
        ...
        if (options.enableMetaHeader) {
            ...
            if (node_process_1.default.versions.bun != null)
                clientMeta += `,bn=${node_process_1.default.versions.bun}`;
            if (node_process_1.default.versions.deno != null)
                clientMeta += `,dn=${node_process_1.default.versions.deno}`;
