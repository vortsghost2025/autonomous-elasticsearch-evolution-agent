...
import { Table, TypeMap, AsyncRecordBatchStreamReader } from 'apache-arrow/Arrow.node.js';
import Client from './client.js';
import * as T from './api/types.js';
import { Id } from './api/types.js';
...
export default class Helpers {
     ...
     */
    search<TDocument = unknown>(params: T.SearchRequest, options?: TransportRequestOptions): Promise<Array<TDocument & {
        _id: Id;
    }>>;
    /**
