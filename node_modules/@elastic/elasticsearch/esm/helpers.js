...
import { tableFromIPC, AsyncRecordBatchStreamReader } from 'apache-arrow/Arrow.node';
...
class Helpers {
    ...
    bulk(options, reqOptions = {}) {
        var _d, _e;
        assert(!((_d = reqOptions.asStream) !== null && _d !== void 0 ? _d : false), 'bulk helper: the asStream request option is not supported');
        const client = this[kClient];
        ...
        function bulkOperation(bulkBody, callback) {
            ...
            function tryBulk(bulkBody, callback) {
                ...
                client.bulk(Object.assign({}, bulkOptions, { operations: bulkBody }), reqOptions)
                    .then(response => {
                    var _d, _e, _f;
