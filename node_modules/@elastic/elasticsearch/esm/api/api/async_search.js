...
class AsyncSearch {
    ...
    async delete(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['async_search.delete'];
    ...
    async get(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['async_search.get'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async status(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['async_search.status'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async submit(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[kAcceptedParams]['async_search.submit'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
