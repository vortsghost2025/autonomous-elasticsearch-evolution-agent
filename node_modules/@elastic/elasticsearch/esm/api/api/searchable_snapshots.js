...
class SearchableSnapshots {
    ...
    async cacheStats(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['searchable_snapshots.cache_stats'];
    ...
    async clearCache(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['searchable_snapshots.clear_cache'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async mount(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[kAcceptedParams]['searchable_snapshots.mount'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async stats(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['searchable_snapshots.stats'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
...
_a = kAcceptedParams;
export default SearchableSnapshots;
