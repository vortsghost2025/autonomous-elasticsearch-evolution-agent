...
class Streams {
    ...
    async logsDisable(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['streams.logs_disable'];
    ...
    async logsEnable(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['streams.logs_enable'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async status(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['streams.status'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
