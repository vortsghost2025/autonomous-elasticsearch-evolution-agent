...
class DanglingIndices {
    ...
    async deleteDanglingIndex(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['dangling_indices.delete_dangling_index'];
    ...
    async importDanglingIndex(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['dangling_indices.import_dangling_index'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
    ...
    async listDanglingIndices(params, options) {
        const { path: acceptedPath } = this[kAcceptedParams]['dangling_indices.list_dangling_indices'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? { ...userQuery } : {};
        let body;
        const userBody = params === null || params === void 0 ? void 0 : params.body;
...
_a = kAcceptedParams;
export default DanglingIndices;
